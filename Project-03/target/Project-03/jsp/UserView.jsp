		...
		%>				
						...
						<!-- Password -->
 							...
 							<div class="input-group mb-3">
 								...
 								placeholder="Confirm Password" value="<%=DataUtility.getStringData(dto.getConfirmPassword())%>">
						...
						%> <%=htmlList%>
							...
							<label><b>Gender</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fas fa-user-tag" style="font-size: 25px;"></i></span>
                    ...
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=UserCtl.OP_UPDATE%>" >
