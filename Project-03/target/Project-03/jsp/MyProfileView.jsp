 	...
 	<div class="row">
 		...
 		<div class="col-md-6">
 			<div class="card input-group-addon">
				<div class="card-body">
					<h3 class="text-center text-primary pb-3">My Profile</h3>
 					...
 					<!-- Form Start -->
						...
						%> <%=htmlList%>
                            ...
                            <div class="text-center">
                                ...
                                <input type="submit" class="btn btn-success" name="operation" value="<%=MyProfileCtl.OP_SAVE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=MyProfileCtl.OP_CHANGE_MY_PASSWORD%>"><br>
