			...
			<div class="col-md-6">
				<div class="card input-group-addon">
                    ...
                    <div class="text-center">                            
                                <button class="btn btn-success" name="operation" value="<%=RoleCtl.OP_UPDATE%>" >Update</button>
                                <button class="btn btn-secondary" name="operation"value="<%=RoleCtl.OP_CANCEL%>">Cancel</button><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <button class="btn btn-success" name="operation" value="<%=RoleCtl.OP_SAVE%>" >Save</button>
                                <button class="btn btn-secondary" name="operation"value="<%=RoleCtl.OP_RESET%>">Reset</button><br>  								                          
                            </div> 							
