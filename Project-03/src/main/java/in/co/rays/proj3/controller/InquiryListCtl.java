 ...
 * Performs operations for list,search,delete operations of Inquiry
 * 
 * @author Nidhi
 * @version 1.0
 *
...
public class InquiryListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<InquiryDTO> list=model.search(dto, pageNo, pageSize);
			List<InquiryDTO> next=model.search(dto, pageNo+1, pageSize);
