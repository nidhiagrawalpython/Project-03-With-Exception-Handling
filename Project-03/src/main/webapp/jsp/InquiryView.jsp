...
<%@page import="in.co.rays.proj3.controller.InquiryCtl"%>
...
<!-- Bean Tag -->
	<jsp:useBean id="dto" class="in.co.rays.proj3.dto.InquiryDTO" scope="request"></jsp:useBean>
				...
				<div class="card input-group-addon">
					<div class="card-body">
						<%
							...
							if(dto.getId()!=null){						
						%>				
						<h3 class="text-center text-primary pb-3">Update Inquiry</h3>
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Inquiry</h3>
						<%} %>
						...
						<!-- Name -->
 							...
 							<div class="input-group mb-3">
 								...
 								<input type="text" class="form-control" name="name"
 									 placeholder="Name" value="<%=DataUtility.getStringData(dto.getName())%>"><br>
 								</div>
 						...
 						<!-- Email -->
							...
							<!-- Subject -->
 							...
 							<div class="input-group mb-3">
 								...
 								value="<%=DataUtility.getStringData(dto.getSubject())%>"><br>
 								</div>
 								<font color="red"><%=ServletUtility.getErrorMessage("subject", request)%></font><br>	 
							...
							<!-- Status -->
 							...
 							<div class="input-group mb-3">
 								...
 								value="<%=DataUtility.getStringData(dto.getStatus())%>"><br>
 								</div>
                    ...
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=InquiryCtl.OP_UPDATE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=InquiryCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=InquiryCtl.OP_SAVE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=InquiryCtl.OP_RESET%>"><br>  								                          
                            </div> 							
